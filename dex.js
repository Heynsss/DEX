/* Moralis init code */
const serverUrl = "https://7hkxrf40vkem.usemoralis.com:2053/server";
const appId = "6pEEkCj79mtbR7CJumnJoanOSEhCmsp3FbxPJnnL";
...
async function formSubmitted(event) {
    ...
    try {
        const quote = await Moralis.Plugins.oneInch.quote({
            chain: 'polygon', // Blockchain you want to use (eth/bsc/polygon/...)
...
async function getTickerData(tickerList) {
    const tokens = await Moralis.Plugins.oneInch.getSupportedTokens({
        chain: 'polygon', // blockchain you want  (eth/bsc/polygon/...)
    });
    console.log(tokens)
